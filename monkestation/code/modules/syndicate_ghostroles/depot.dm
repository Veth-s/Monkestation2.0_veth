...
/obj/effect/mob_spawn/ghost_role/human/lavaland_syndicate/depot_syndicate
	...
	important_text = "DO NOT abandon the base, approach or communicate with active Nanotrasen installations. This includes but is not limited to faxing or teleporting anything to them. However, you may freely explore your surrounding within your current space quadrant (Z-Level), and may fly to other Syndicate bases in space to deliver and move supplies with the permission of the Quartermaster."
...
/obj/effect/mob_spawn/ghost_role/human/lavaland_syndicate/depot_syndicate/guard
	...
	important_text = "DO NOT abandon the base, approach or communicate with active Nanotrasen installations. This includes but is not limited to faxing or teleporting anything to them. You are here to protect it, and cannot perform deliveries."
...
/obj/effect/mob_spawn/ghost_role/human/lavaland_syndicate/depot_syndicate/quartermaster
	...
	important_text = "DO NOT abandon the base, approach or communicate with active Nanotrasen installations. This includes but is not limited to faxing or teleporting anything to them. You can, however, authorise depot workers to perform deliveries outside the local quadrant (Z-level) to other space outposts (but not go yourself), and may freely explore the local quadrant (Z-level) alongside them."
