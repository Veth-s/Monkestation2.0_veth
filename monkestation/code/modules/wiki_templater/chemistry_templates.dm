/datum/wiki_template/chemical_reaction/proc/generate_output(datum/chemical_reaction/recipe)
    ...
    var/category_string = ""  // The category of the reaction (e.g., Medicine)

    // Determine the category of the reaction (e.g., Medicine)
    if (istype(recipe, /datum/chemical_reaction/medicine))
        category_string = "Medicine"
    else
        category_string = "Other Category"  // Modify this for other categories if needed
    ...
    var/created_template = "### [category_string]: [name_string] \n"  // Added category to heading
    created_template += "| --- | --- | --- | \n"
...
/proc/generate_chemical_reaction_wiki_templates()
    ...
    for (var/type in typesof(/datum/chemical_reaction))  // Search for all chemical reactions
        var/datum/chemical_reaction/new_recipe = new type
